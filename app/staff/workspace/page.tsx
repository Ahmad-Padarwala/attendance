                    ...
                    <div className="w-[95%] mx-auto py-5">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-sm font-semibold text-gray-700 mt-1">My Workspace</p>
                            </div>
                            <div className="flex gap-3">
                                <button
                                    onClick={() => router.push('/staff/dashboard')}
                                    className="group bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-5 py-2.5 rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all shadow-md hover:shadow-lg font-semibold flex items-center gap-2 hover:scale-105"
                                >
