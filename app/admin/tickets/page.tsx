...
export default function AdminTicketsPage() {
  ...
  const fetchTickets = async () => {
    try {
      ...
      const url = queryString ? `/api/admin/tickets?${queryString}` : '/api/admin/tickets';
        ...
        <header className="bg-white/30 backdrop-blur-xl shadow-lg border-b border-white/40">
          <div className="w-[95%] mx-auto py-5 flex justify-between items-center">
            <div>
              ...
              <p className="text-sm font-semibold text-gray-700 mt-1">Manage and track all tickets</p>
            </div>
          ...
          <div className="mb-6 bg-white rounded-xl shadow-md p-5 border border-gray-100">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-2.5 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg font-semibold flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
