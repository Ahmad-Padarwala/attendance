    ...
    <>
      ...
      <div className="mb-4 flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative group">
          <div className={`absolute inset-0 rounded-xl opacity-20 group-hover:opacity-30 transition-opacity ${
            statusFilter === 'punched_in' ? 'bg-gradient-to-r from-green-400 to-emerald-500' :
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
              <div className={`flex items-center ${
                statusFilter === 'punched_in' ? 'text-green-600' :
            ...
            <select
              ...
              className={`relative appearance-none w-full sm:w-64 pl-12 pr-10 py-3 bg-white/90 backdrop-blur-sm border-2 rounded-xl font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all shadow-md hover:shadow-lg cursor-pointer ${
                statusFilter === 'punched_in' ? 'border-green-300 focus:ring-green-500 text-green-700' :
            ...
            <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
              <svg className={`w-5 h-5 transition-colors ${
                statusFilter === 'punched_in' ? 'text-green-500' :
